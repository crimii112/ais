...
const Metal = ({ type }) => {
    ...
    const apiData = useMemo(() => ({
        ...
        polllist: pollutant,
        type: 'tmp',
    }), [config.page, dateList, stationList, searchCond, pollutant]);
...
const signList2 = [
    { id: 'Zero', text: '0 -> ', checked: true, signvalue: 'N.D.', onCheckbox: false },
    { id: 'Null', text: 'NULL -> ', checked: true, signvalue: '-', onCheckbox: false },
];
